            ...
            <div class="col-md-2">
                ...
                <div class="btn-group">
                  <ul class="nav-pills" role="tablist">
                    ...
                    <li role="presentation" class="btn btn-danger dropdown-toggle btn-xs"><a id="drop4" href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false"><em class="fa fa-plus" style="font-size:11px; color:#FFF;"></em></a>
                      <ul id="menu6" class="dropdown-menu animated fadeInDown" role="menu">
                      
                      <%if sonkate=1 then%>
                <%else%>
               <li role="presentation"><a role="menuitem" tabindex="-1" href="baslik.asp?id=<%=strid%>&baslik=<%=strid%>&sek=<%=mmmGenel("anasek")%>" class="btn btn-success dropdown-toggle btn-xs" data-toggle="modal" data-target="#baslikmodal" style="color:#fff; text-align:left;">Alt Sayfa Ekle</a></li>
                <%end if%>
                
                <%if toplam5="0" then%>
                <%else%>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="?dkate2=<%=strid%>&sek=<%=dkate2%>" class="btn btn-info dropdown-toggle btn-xs"><em class="fa fa-list-alt" style="font-size:11px;"></em> Alt Sayfalar (<%=toplam5%>)</em></a></li>
                <%end if%>

                <%if toplam4="0" then%>
                <%else%>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="?<%=linked%>dkate2=<%=strid%>&sek=<%=dkate2*1%>" class="btn btn-warning dropdown-toggle btn-xs" style="color:#fff; text-align:left;"><em class="fa fa-files-o" style="font-size:11px;"></em>Sayfa İçeriği</a></li>
                <%end if%>

                <%if mayarlar=1 then%>
                <li role="presentation"><a role="menuitem" tabindex="-1" href="ortak_sayfalar_ayar.asp?dkate2=<%=strid%>&urunid=<%=strurunid%>&sayfaayar=modul" class="btn btn-dark dropdown-toggle btn-xs" style="color:#fff; text-align:left;"><em class="fa fa-th-large" style="font-size:11px;"></em> Blok Ayarları</a>
                </li>
                <%else%>
                <%end if%>
                
                <li role="presentation"><a role="menuitem" tabindex="-1" href="galeri.asp?baslik=<%=strid%>&amp;dkate2=<%=dkate2%>&sek=<%=dkate2*1%>" class="btn btn-default dropdown-toggle btn-xs" style="text-align:left;"><em class="fa fa-camera" style="font-size:16px;"></em> Resimler (<%=toplam6%>) </a> </li>
          <%
...
<li role="presentation"><a role="menuitem" tabindex="-1" class="btn btn-danger dropdown-toggle btn-xs" style="text-align:left; color:#FFF;">İçerik Ekle</a> </li>
  ...
  %>
                ...
                <div class="btn-group">
                  <ul class="nav-pills" role="tablist">
                    ...
                    <li role="presentation" class="btn btn-dark dropdown-toggle btn-xs"><a id="drop4" href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false"><em class="fa fa-ellipsis-v" style="font-size:11px; color:#FFF;"></em></a>
                      <ul id="menu6" class="dropdown-menu animated fadeInDown" role="menu">
			   ...
			   <%if strsifreli = "1" Then
                ...
                <%if strmenugosterim = "1" Then
						  ...
						  response.Write(checkboxcreat("menugosterim","Üst Menü Gösterimi",iks,cbcdisstr,cbccheckstr,"success"))%></a>
                          </li>
